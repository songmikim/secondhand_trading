...
public class AccessTokenTest {
    ...
    void test() {
        ...
        body.add("client_id", "2ccabb1a6e951cdef4254a969782cb2f");
        body.add("redirect_uri", "http://localhost:3000/member/social/callback/kakao");
        body.add("code", "dGNjCNF-JRtPsCXf0byA7ATdLL_ES_lQ3tq4RF5g4ZBhM4KYaneyUgAAAAQKDSGWAAABmBur_EikJA3lYdtGWQ");
